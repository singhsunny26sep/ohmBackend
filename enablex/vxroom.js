...
vcxroom.getToken = async (details, callback) => {
...
vcxroom.getAllRooms = (callback) => {
  ...
  options.method = "GET";
  vcxutil.connectServer(options, null, (status, data) => { callback(data); });
};
...
vcxroom.createRoom = (roomObj, callback) => {
